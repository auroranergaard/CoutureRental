...
*/
    ...
    public void initialize(final URL location, final ResourceBundle resources) {
        InputStream inputStream = getClass().getResourceAsStream("/pictures/promdress.jpeg");

        if (inputStream != null) {
            Image image = new Image(inputStream);
            promdress.setImage(image);
        } else {
            System.err.println("Input stream is null. Unable to create Image.");
        }
    }
